...
const Navbar = props => {
    ...
    return (
    <div className="px-8 fixed left-0 top-0 pt-6 w-full flex justify-start items-center z-10 mix-blend-difference text-silver ">
        <div onClick={() => window.location.replace('#home')} className="flex flex-col font-maven duration-500 group hover:text-neon cursor-pointer" >
