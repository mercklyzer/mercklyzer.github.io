...
const Hero = ({ className }) => {
  ...
  return (
    <div
      id="home"
      className={`relative w-full min-h-screen pb-12 section pt-24 ${className} flex flex-col justify-between content-between bg-dark text-silver font-poppins`}
    >
      <div className="flex flex-col lg:flex-row justify-between ">
        <div className="text-md md:text-xl lg:text-xl xl:text-2xl ">
          ...
          <div className="inline-block">
            <div className="block relative overflow-hidden">
              <span className="text-neon font-semibold"> LYZER BAUTISTA, </span>{" "}
            ...
            <div className="block relative overflow-hidden">
              AND GRADUATED AS{" "}
              <span className="text-neon font-semibold"> SUMMA CUM LAUDE </span>
              <div className="absolute inset-0 bg-dark line-block"></div>
            </div>
            <div className="block relative overflow-hidden">
        ...
        <div className="flex justify-end my-6 sm:my-4 md:mt-14 lg:mt-0 relative overflow-hidden">
          ...
          <img
            src={Profile}
            className="object-cover max-w-[50vw] sm:max-w-[35vw] md:max-w-[30vw] lg:max-w-[26vw] xl:max-w-[18vw] "
          />
        </div>
      </div>
        ...
        <div className="flex justify-between items-end w-full flex-1 md:mr-12">
          ...
          <div className="flex flex-col md:flex-row justify-end items-end ml-12">
            <div className="relative overflow-hidden">
              ...
              <Link
                className="md:mr-4 text-sm md:text-md lg:text-lg mb-4 md:mb-0"
                name="Resume"
                link={Resume}
              />
            ...
            <div className="relative overflow-hidden">
              <Link
                className="md:mr-4 text-sm md:text-md lg:text-lg mb-4 md:mb-0"
                name="LinkedIn"
                link="https://www.linkedin.com/in/lyzer-merck-bautista/"
              />
              <div className="link-block bg-dark inset-0 absolute"></div>
            </div>
            <div className="relative overflow-hidden">
              <Link
                className="md:mr-4 text-sm md:text-md lg:text-lg mb-4 md:mb-0"
                name="GitHub"
                link="https://github.com/mercklyzer"
              />
              <div className="link-block bg-dark inset-0 absolute"></div>
            </div>
          </div>
