    ...
    return (
        <div className="bg-dark" id="projects">
            ...
            <div className="section grid grid-cols-1 md:grid-cols-2 md:gap-x-12 lg:gap-x-24 xl:gap-x-64 gap-y-20 md:gap-y-32 lg:gap-y-24 py-32">
                ...
                <Project image={Trailyzer} title="Trailyzer" visitLink="https://mercklyzer.github.io/trailyzer/" />
                <Project image={LyzCo} title="Lyz Co" visitLink="https://mercklyzer.github.io/Lyz-Co/"/>
